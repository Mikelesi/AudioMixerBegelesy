...
favorites_listbox.grid(row=7, column=0, columnspan=2, padx=5, pady=5, sticky=(tk.W, tk.E, tk.N, tk.S))

# Button to add to favorites
add_favorite_button = ttk.Button(frame, text="Add to Favorites", command=add_to_favorites, style="Custom.TButton")
add_favorite_button.grid(row=8, column=0, padx=5, pady=5, sticky=(tk.W, tk.E))
...
remove_favorite_button.grid(row=8, column=1, padx=5, pady=5, sticky=(tk.W, tk.E))
...
credits_label.grid(row=9, column=0, columnspan=2)

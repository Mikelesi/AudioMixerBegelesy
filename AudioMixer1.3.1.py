...
cycle_key_label = ttk.Label(frame, text="Cycle Favorites Session Key:", style="Custom.TLabel")
...
remove_favorite_button.grid(row=9, column=1, padx=5, pady=5, sticky=(tk.W, tk.E))
...
credits_label.grid(row=10, column=0, columnspan=2)
